...
\begin{itemize}
    ...
    \item[M:] Same as in case of granted junior professorships, but we had extra reviewers \emoji{relieved-face}.
\end{itemize}
\end{frame}
